      ...
      >
        <div className="h-16 px-4 sm:px-6 border-b border-gray-800/50 flex items-center justify-between bg-gray-900/50 backdrop-blur-sm">
          <div className="flex items-center gap-3">
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg ${logoError ? 'bg-gradient-to-br from-primary-500 to-primary-600 shadow-primary-500/30' : 'overflow-hidden'}`}>
              {logoError ? (
